...
let buttonpass = document.getElementById("button-pass");
...
if (language == "es") {
    ...
    info_name.childNodes[0].data = "Nombre Usuario: ";
    info_correo.childNodes[0].data = "Correo: ";
    buttonpass.defaultValue = "CREAR LISTA";
} 
